...
export interface ClientRegisterWrapperHandle {
	triggerPendingAction: () => void;
}

interface ClientRegisterWrapperProps {
	onRegistrationComplete?: (userData: any) => void;
}

const ClientRegisterWrapper = forwardRef<
	ClientRegisterWrapperHandle,
	ClientRegisterWrapperProps
>(({ onRegistrationComplete }, ref) => {
	...
	const handleRegister = async (e: React.FormEvent) => {
		...
		try {
			// Register with explicit role as client
		...
		<>
			<div className={classes.container}>
				...
				>
					...
					<h2 className={classes.formTitle}>Create Client Account</h2>
					<p
						style={{ color: "#666", marginBottom: "30px", textAlign: "center" }}
					>
						Register to book appointments and manage your vehicles
					</p>
...
export default ClientRegisterWrapper;
